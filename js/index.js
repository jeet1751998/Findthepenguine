$(document).ready( function() {
    ...
    var penguinImages = ['images/penguin_1.png','images/penguin_2.png','images/penguin_3.png','images/penguin_4.png','images/penguin_5.png','images/penguin_6.png','images/penguin_7.png','images/penguin_8.png','images/devil.png'];
    ...
    var hole9 = document.getElementById('devil');
        ...
        if(e.classList.contains('clicked'))
            {
                ...
                if(str === 'images/devil.png' )
                    {
                        var animal = 'url('+str+')';
                        e.style.backgroundImage = animal;
                        var devilGrowl = new Audio('media/devil.wav');
                        devilGrowl.play();
    ...
    function game_over ()
    {
         ...
         var pengPieces = document.getElementsByClassName('pengPieces');
         for (var i = 0; i < pengPieces.length; i++)
             {
                 pengPieces[i].style.backgroundImage = '';
                 pengPieces[i].classList.remove('clicked');
             }
